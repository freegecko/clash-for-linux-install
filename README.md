...
```bash
$ clashupdate http://freegecko.com/api/v1/client/subscribe?token=af1a2f4ab #此处以自由壁虎机场freegecko.com 为例子
👌 正在下载：原配置已备份...
🍃 下载成功：内核验证配置...
🍃 订阅更新成功
...
$ clashupdate log
✅ [2025-02-23 22:45:23] 订阅更新成功：http://freegecko.com/api/v1/client/subscribe?token=af1a2f4ab #此处以自由壁虎机场freegecko.com 为例子
```
